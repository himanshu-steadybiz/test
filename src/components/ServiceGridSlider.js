...
class ServiceGridSlider extends Component{
    render(){
        ...
        let data = [
            {img: 'service1.jpg', iconName: 'flaticon-002-welding', serviceTitle: '11 Minning', serviceExcerpt: 'Lorem ipsum dolor sit amet consect adipisi elit sed do eiusm tempor', serviceUrl: 'service-details-left-sidebar'},
...
ff                        <div className="service-grid-item__image-wrapper">
