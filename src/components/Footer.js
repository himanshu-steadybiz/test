                        ...
                        <div className="col-lg-12">
                            ...
                            <div className="row">
                                ...
                                <div className="footer-intro-wrapper">
                                    ...
                                    हरियाणा की पहली शिव नंदी गऊ सेवा समिति द्वारा संचालित शिव नंदी शाला टोहाना
                                    </div>
                                </div>
                                </div>
                                ...
                                <div className="footer-widget">
                                    ...
                                    <ul className="footer-widget__navigation">
                                    <li><a className='footer.inactiveLink' >कॉरपोरेशन बैंक अकाउंट नंबर 318400101000852 IFSC Code CORP0003184</a></li>
                                    <li></li>
                                ...
                                <div className="footer-widget mb-0">
                                    ...
                                    <p className="address">शहीद चौक आर एम सी हॉस्पिटल के पीछे
टोहाना जिला फतेहाबाद हरियाणा 125120</p>
                                    <ul className="contact-details">
                                        <li><span>M:</span>9896742540</li>
                                        <li><span>M:</span>9890790200</li>
