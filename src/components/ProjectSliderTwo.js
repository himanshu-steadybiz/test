...
class ServiceGridSlider extends Component{
    render(){
        ...
        let data = [
            ...
            {img: 'service2.jpg', serviceTitle: 'रामबाग उम्मीद जीने की', serviceExcerpt: 'नंदी शाला द्वारा वृद्ध लोगों की सेवा के लिए डे केयर सेंटर वृद्ध आश्रम बनाया जा रहा है जिसमें बुजुर्ग लोगों के रुकने खाने-पीने व  उनकी  मेडिकल चिकित्सा से संबंधित सभी सुविधाएं मिला करेंगी ।', serviceUrl: 'service-details-left-sidebar'},
            {img: 'service1.jpg', serviceTitle: 'महात्मा ज्योतिबा फुले पुस्तकालय', serviceExcerpt: 'महात्मा ज्योतिबा फुले पुस्तकालय नंदी शाला टोहाना द्वारा जल्द ही एक लाइब्रेरी का निर्माण किया जा रहा है जहां लोगों को जहां बच्चों को पढ़ने के लिए उचित स्थान के साथ-साथ अनेक महत्वपूर्ण किताबें व कंपटीशन एग्जाम की तैयारी करवाई जाएगी', serviceUrl: 'service-details-left-sidebar'},
                ...
                <div className="swiper-slide" key={i}>
                    ...
                    <div className="service-grid-item__image">
                        ...
                        <a href={`${process.env.PUBLIC_URL}/${val.serviceUrl}`}>
                            <img src={`assets/img/upcomingProjects/${val.img}`} className="img-fluid" alt="" />
                        </a>
                        </div>
                    </div>
