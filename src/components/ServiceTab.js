            ...
            <div>
                ...
                <div className="container">
                    ...
                    <div className="col-lg-12">
                        ...
                        <h2 className="section-title section-space--bottom--50">हमारी सेवाएं</h2>
                        </div>
                    </div>
                    <div className="col-lg-12">
                        {/* service tab wrapper */}
