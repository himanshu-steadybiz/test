...
import VedioGalary from './service/VedioGalary';
        ...
        return(
            <BrowserRouter basename={'/'}>
                <Switch>
                    ...
                    <Route exact path={`${process.env.PUBLIC_URL}/vedio-galary`} component={VedioGalary}/>
                    ...
                    <Route exact path={`${process.env.PUBLIC_URL}/donate-us`} component={DonateUs}/>
